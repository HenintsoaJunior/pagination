...
INSERT INTO Guide (nom_guide, description, disponibilite, id_partenaire,id_ville) VALUES
('Jean Guide', 'Guide expérimenté à Madagascar', 1, 'PAR3','VIL1'),
('Emma Guide', 'Spécialiste des parcs nationaux', 1, 'PAR3','VIL2'),
('Luc Guide', 'Guide touristique à Antananarivo', 0, 'PAR3','VIL3'),
('Sophie Guide', 'Guide pour les circuits culturels', 1, 'PAR3','VIL4'),
('Pierre Guide', 'Guide pour les excursions en montagne', 1, 'PAR3','VIL5');
...
INSERT INTO transport (nom_transport, description,tarif, id_partenaire, id_categorie_transport,id_ville) VALUES
('Voiture de Location Aéroport', 'Service de location de voiture à aéroport', 120000.00,'PAR1', 'CTR1','VIL1'),
('Bus Touristique Madagascar', 'Circuit touristique en bus à Madagascar', 89000.00,'PAR2', 'CTR2','VIL2'),
('Train Express Central', 'Train express entre les grandes villes',1200000.00 ,'PAR2','CTR3','VIL3'),
('Vol Local Madagascar', 'Vol intérieur entre les villes de Madagascar',300000.00 ,'PAR2','CTR4','VIL4'),
('Croisière Fluviale Pangalanes', 'Croisière fluviale sur le canal des Pangalanes', 430000.00, 'PAR2', 'CTR5','VIL5');
