...
CREATE TABLE categorie_transport(
    id_categorie_transport TEXT DEFAULT generer_id_categorie_transport(),
    libelle VARCHAR(150) NOT NULL,
    PRIMARY KEY(id_categorie_transport)
);
...
CREATE TABLE Transport(
    ...
    tarif NUMERIC(18,2) NOT NULL,
    date_insertion TIMESTAMP DEFAULT NOW(),
    id_categorie_transport TEXT NOT NULL,
    id_partenaire TEXT NOT NULL,
    id_ville TEXT,
    PRIMARY KEY(id_transport),
    FOREIGN KEY(id_categorie_transport) REFERENCES categorie_transport(id_categorie_transport),
    FOREIGN KEY(id_partenaire) REFERENCES partenaire(id_partenaire),
    FOREIGN KEY(id_ville) REFERENCES Ville(id_ville)
);
